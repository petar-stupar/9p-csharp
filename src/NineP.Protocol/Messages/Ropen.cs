...
/// <summary>
/// Answers a Topen with the qid and the iounit the server will honour (reference §5.5).
/// </summary>
...
public readonly record struct Ropen(ushort Tag, Qid Qid, uint Iounit)
    : IMessage
{
    static MessageType IMessage.Type => MessageType.Ropen;
}

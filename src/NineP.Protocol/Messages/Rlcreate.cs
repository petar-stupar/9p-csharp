...
/// <summary>
/// Answers a Tlcreate with the qid of the new file and the iounit (reference §3.4).
/// </summary>
...
public readonly record struct Rlcreate(ushort Tag, Qid Qid, uint Iounit)
    : IMessage
{
    static MessageType IMessage.Type => MessageType.Rlcreate;
}

...
/// <summary>
/// The whole of reference §9: all 88 golden frames decode into their typed records in the dialect
...
{
    private const int VectorCount = 88;
    ...
    /// <summary>The fixture holds exactly the 88 frames reference §9 promises.</summary>
    [Fact]
    public void FixtureHoldsEightyEightVectors() => Assert.Equal(VectorCount, WireVectors.All.Count);

    /// <summary>
    /// The 88 frames cover 66 distinct message names — every wire-legal type of reference §2 — so
